...
# ─── Clics críticos ──────────────────────────────────────────────────────────
CRIT_CHANCE = 0.05      # probabilidad base de crítico
CRIT_MULT   = 10.0      # multiplicador del clic crítico

# ─── Moneda dorada (evento aleatorio) ────────────────────────────────────────
# Cruza la pantalla cada GOLDEN_MIN..GOLDEN_MAX segundos; clicarla da un bono.
GOLDEN_MIN = 45  if MODE == "demo" else 90
GOLDEN_MAX = 110 if MODE == "demo" else 240

# ─── Selector de minijuegos ──────────────────────────────────────────────────
# Tras esta cantidad de victorias totales puedes elegir cuál jugar.
MINI_SELECT_WINS = 3

# ─── Mejoras de prestigio (permanentes, compradas con PP) ────────────────────
# Sobreviven a los reinicios de prestige. Campos:
#   effect → clave que aplica GameState: pps_mult / click_mult / crit_chance /
#            start_workers / golden_freq / boost_dur
PRESTIGE_UPGRADES = [
    {"id": "pp_workers", "icon": "●", "name": "Equipo Veterano",
     "desc": "Empiezas cada reinicio con 5 trabajadores",
     "cost": 2, "effect": "start_workers", "value": 5},
    {"id": "pp_pps",     "icon": "⚡", "name": "Memoria Industrial",
     "desc": "+25% de producción permanente",
     "cost": 3, "effect": "pps_mult", "value": 1.25},
    {"id": "pp_click",   "icon": "▲", "name": "Dedos Entrenados",
     "desc": "+25% por clic permanente",
     "cost": 2, "effect": "click_mult", "value": 1.25},
    {"id": "pp_crit",    "icon": "★", "name": "Suerte Dorada",
     "desc": "Probabilidad de crítico 5% → 10%",
     "cost": 3, "effect": "crit_chance", "value": 0.10},
    {"id": "pp_golden",  "icon": "◆", "name": "Imán Dorado",
     "desc": "Las monedas doradas aparecen el doble de seguido",
     "cost": 2, "effect": "golden_freq", "value": 0.5},
