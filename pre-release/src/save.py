"""Guardado/carga de partida en JSON (pre-release).

El archivo vive en el home del usuario para sobrevivir a `git clean` y a
mover el repo. Los boosts temporales (minijuego/QTE) no se serializan.
"""
import json
import os
import time
...
SAVE_PATH = os.path.expanduser("~/.clicker_prerelease_save.json")

_SCALAR_FIELDS = [
    "points", "total_points", "click_value", "click_mult",
    "prestige_count", "prestige_multiplier",
